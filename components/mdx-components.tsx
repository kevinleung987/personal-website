...
import { Box, chakra, Code, Heading, Image, Link, ListItem, Table, Text } from "@chakra-ui/react";
...
const MDXComponents = {
  ...
  blockquote: (props: any) => (
    <chakra.blockquote borderLeft="4px" borderColor="gray" p="3" my={VERT_SPACE} {...props} />
  ),
